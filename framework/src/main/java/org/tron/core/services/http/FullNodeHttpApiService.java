...
public class FullNodeHttpApiService extends HttpService {
    ...
    @Autowired
    private BackfillSectionBloomServlet backfillSectionBloomServlet;
    ...
    protected void addServlet(ServletContextHandler context) {
        ...
        // ServletHolder(createShieldedTransactionWithoutSpendAuthSigServlet),
        ...
        context.addServlet(new ServletHolder(backfillSectionBloomServlet),
                "/wallet/backfillsectionbloom");
    ...
    protected void addFilter(ServletContextHandler context) {
        ...
        context.addFilter(new FilterHolder(httpApiAccessFilter), "/*",
                EnumSet.allOf(DispatcherType.class));
        // note: if the pathSpec of servlet is not started with wallet, it should be
        // included here
